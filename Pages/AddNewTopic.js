            ...
            <Row>
              <Col lg={12}>
                <div className="page-h-with-btn">
                  <h2 className="mb-0">Add New Topic</h2>
                  <div>
                    <Link to="/add-new-expert">Publish to Syllabus</Link>
                  </div>
                </div>
              </Col>
              <Col lg={12}>
                  ...
                  <div className="select-box">
                    <Form.Select aria-label="Default select example">
                      ...
                      <option value="1">9</option>
                        ...
                        <div className="page-h-with-btn">
                          <div>
                            <Link to="/add-new-section">Add New Section</Link>
                          </div>
                        </div>
                      </div>
                        ...
                        <Table size="sm" className="table-cmn">
                          <thead>
                            <tr className="border-none">
                              <th className="id-field">Section Name</th>
                              <th className="id-field">Lesson Name</th>
