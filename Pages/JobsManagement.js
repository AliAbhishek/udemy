            ...
            <Row>
              <Col lg={12}>
                <div className="page-h-with-btn">
                  <h2>Summary</h2>
                  <div>
                    <Link to="/post-new-job">Post a New Job</Link>
                  </div>
                </div>
              </Col>
                ...
                <Table size="sm" className="table-cmn">
                  <thead>
                    <tr className="border-none">
                      <th className="id-field">Company</th>
                      <th className="id-field">Role Title</th>
                      <th className="id-field">Location</th>
                      <th className="id-field">Salary Range </th>
                      <th className="id-field">Type</th>
                      <th className="id-field">Applicants</th>
