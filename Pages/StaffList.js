                    ...
                    <div className="details-tabs-right">
                      <div className="user-search">
                        <div>
                          ...
                          <h2>Staff List</h2>
                          <p>
                            Below is a list of staff members and their assigned
                            roles
                          </p>
                        </div>
                        ...
                        <Table size="sm" className="table-cmn">
                          <thead>
                            <tr className="border-none">
                              <th className="id-field">Staff Name</th>
                              <th className="id-field">Email</th>
                              <th className="id-field">Role</th>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div className="first-user">John Doe</div>
                              </td>
