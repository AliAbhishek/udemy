...
export default function UserDetails() {
  ...
  const { userDetails } = useSelector((state) => state.usercreation);
  console.log(userDetails, "111111");
              ...
              <Col lg={12}>
                <div className="commn-details-card">
                  <div className="top-detail-user">
                    <div className="user-d-name">
                      ...
                      <div className="user-type">
                        User Type :{" "}
                        <span>
                          {userDetails?.data?.assigned_role == 1
                            ? "Super Admin"
                            : userDetails?.data?.assigned_role == 2
                            ? "Admin"
                            : "Reader"}
                        </span>
                      </div>
                  ...
                  <div className="user-profile-details">
                    <div className="">
                      {userDetails?.data?.profile_pic ? (
                        <img src={userDetails?.data?.profile_pic} />
                      ) : (
                        <img
                      ...
                      <div className="profile-details-contain">
                        <div>
                          ...
                          <div className="w-icon-set">
                            <img
                              src={require("../Assets/Images/XP-BALANCE.png")}
                            />
                            <div>
                              <p>XP BALANCE</p>
                              <div> 0</div>
                        ...
                        <div>
                          <div>
                            <p>COUNTRY</p>
                            <div>{userDetails?.country_code || "N/A"}</div>
                          </div>
                          ...
                          <div>
                            <p>LAST LOGIN</p>
                            <div>
                              {moment(userDetails?.data?.last_login).format(
                                "MMM DD, YYYY"
                              )}
                            </div>
                          </div>
                          <div className="w-icon-set">
                            <img
                              src={require("../Assets/Images/CURRENT-STREAKS.png")}
                            />
                            <div>
                              <p>CURRENT STREAKS</p>
                              <div> 0</div>
                  ...
                  <div className="profile-details-tabs">
                    <div className="details-tabs-left">
                      <ul>
                        <li className="active">Course Enrollments</li>
                        <li>Activity Logs</li>
                      </ul>
                    </div>
                    <div className="details-tabs-right">
                      ...
                      <p>
                        John is currently enrolled in the following courses:
                      </p>
                        ...
                        <Table size="sm" className="table-cmn">
                          <thead>
                            <tr className="border-none">
                              ...
                              <th className="id-field">Enrollment Date</th>
                              <th className="id-field">Progress</th>
                              <th className="id-field">Last Activity </th>
                            </tr>
                          </thead>
                          <tr
                            style={{
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>Feb 5, 2024</td>
                              <td>
                                <p className="text-warning">60% completed</p>
                              </td>
                              <td> March 10, 2024</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>Feb 5, 2024</td>
                              <td>
                                <p className="text-danger">20% completed</p>
                              </td>
                              <td> March 10, 2024</td>
                            </tr>{" "}
                            <tr>
