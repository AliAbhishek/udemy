...
export default function IndustryExpertsManagement() {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const { expertList, loading,pageInRedux} = useSelector((state) => state.creation);
  console.log(pageInRedux, "pageInRedux");
            ...
            <Row>
              <Col lg={12}>
                <div className="page-h-with-btn">
                  <h2>Summary</h2>
                  <div>
                    <Link to="/new-expert/add">Add New Expert</Link>
                  </div>
                </div>
              </Col>
                        ...
                        <div className="row mt-3">
                          <Col lg={3}>
                            <div className="left-session">
                              ...
                              <h2>
                                {expertList?.count} <span>+12%</span>
                              </h2>
                            </div>
                          </Col>
                          <Col lg={3}>
                            <div className="left-session">
                              <p>Expert Engagement</p>
                              <h2>
                                {expertList?.engagement_metrices}{" "}
                                <span>12%</span>
                              </h2>
                            </div>
                          </Col>
                        ...
                        return (
                          <tr>
                            <td>
                              <div
                                onClick={() => {
                                  navigate(`/expert-details/${expert?._id}`);
                              ...
                              <div className="action user-management ">
                                <Dropdown>
                                  ...
                                  <Dropdown.Menu>
                                    ...
                                    <div
                                      onClick={() => {
                                        navigate(`/new-expert/${expert?._id}`);
                                      }}
                ...
                {expertList?.data?.length > 0 && (
                  <div className="pagination-section">
                    <ShowingResult
                      page={pagination}
                      limit={limit}
                      totalUser={expertList?.count}
                      length={expertList?.data?.length}
                    />
                    <div className="pagination-block">
                      <PaginationComponent
                        currentPage={pagination}
                        totalCount={expertList?.count}
                        totalPages={Math.ceil(expertList?.count / limit)}
